...
const BHM_SEMESTERS = [
  { sem: "Semester 1", total_credits: 19, subjects: [
    { code: "BHCC 6113", name: "Fundamentals of Management",                         credits: 3 },
    { code: "BHCD 6124", name: "Fundamentals of Kitchen",                            credits: 4 },
    { code: "ENG 6003",  name: "English 1",                                          credits: 3 },
    { code: "BHCD 6113", name: "Introduction to Hospitality and Tourism Management", credits: 3 },
    { code: "BHCD 6123", name: "Food and Beverage Management",                       credits: 3 },
    { code: "BHCD 6263", name: "Front Office Management",                            credits: 3 },
  ]},
  { sem: "Semester 2", total_credits: 18, subjects: [
    { code: "BHCD 6373", name: "Housekeeping Management",                            credits: 3 },
    { code: "BHCD 6253", name: "Hospitality Accounting",                             credits: 3 },
    { code: "BHCD 6383", name: "Hospitality Human Resource Management",              credits: 3 },
    { code: "ENG 6004",  name: "English 2",                                          credits: 3 },
    { code: "FRN 6901",  name: "Hotel French",                                       credits: 3 },
    { code: "BHCD 6314", name: "Food Production Operation",                          credits: 3 },
  ]},
  { sem: "Semester 3", total_credits: 18, subjects: [
    { code: "BHCD 6893", name: "Hospitality Training and Development",               credits: 3 },
    { code: "BHE 6803",  name: "Travel and Tour",                                    credits: 3 },
    { code: "BHCD 6483", name: "Hospitality Service Management",                     credits: 3 },
    { code: "BHCD 6403", name: "Hospitality Marketing",                              credits: 3 },
    { code: "BHCD 6413", name: "Hospitality Revenue Management",                     credits: 3 },
    { code: "BHE 6973",  name: "Customer Service in Hospitality Industry",           credits: 3 },
  ]},
  { sem: "Semester 4", total_credits: 18, subjects: [
    { code: "BHE 6423",  name: "Food Culture",                                       credits: 3 },
    { code: "BHCD 6653", name: "Hospitality Management Accounting",                  credits: 3 },
    { code: "BHCD 6663", name: "Hotel Management",                                   credits: 3 },
    { code: "BHCD 6523", name: "Hospitality Information System",                     credits: 3 },
    { code: "BHCD 6543", name: "Hospitality Strategic Management",                   credits: 3 },
    { code: "BHCD 6533", name: "Hospitality Procurement",                            credits: 3 },
  ]},
  { sem: "Semester 5", total_credits: 17, subjects: [
    { code: "MPU 3232",  name: "Human Relations and Leadership Skills",              credits: 2 },
    { code: "BHE 6313",  name: "Tourism Planning and Development",                   credits: 3 },
    { code: "BHCC 6733", name: "Organizational Behavior",                            credits: 3 },
    { code: "BHCD 6773", name: "Restaurant Operation Analysis",                      credits: 3 },
    { code: "BHCC 6743", name: "Entrepreneurship",                                   credits: 3 },
    { code: "BHCD 6783", name: "Research Methodology",                               credits: 3 },
  ]},
  { sem: "Semester 6", total_credits: 18, subjects: [
    { code: "BHE 6743",  name: "Environmental Management in Hospitality Industry",   credits: 3 },
    { code: "BHCD 6823", name: "Restaurant Layout and Design",                       credits: 3 },
    { code: "BHCD 6813", name: "Public Relation",                                    credits: 3 },
    { code: "BHE 6963",  name: "Recreation and Leisure Management",                  credits: 3 },
    { code: "BHE 6863",  name: "Hospitality Law",                                    credits: 3 },
    { code: "BHCD 6243", name: "Event Management",                                   credits: 3 },
  ]},
  { sem: "Semester 7 · Industrial Training", total_credits: 8, subjects: [
    { code: "BHM 6918",  name: "Industrial Training",                                credits: 8 },
  ]},
  { sem: "Semester 8 · Final Submission", total_credits: 4, subjects: [
    { code: "BHM 6920",  name: "Industrial Training Report",                         credits: 4 },
  ]},
];
...
export const metadata = {
  title: "Bachelor of Science (Hons) in Hospitality Management (BHM) – Western Mega College",
      ...
      <div style={{ background:"var(--color-surface)", borderBottom:"1px solid var(--color-border)" }}>
        <div className="container py-5 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { icon: Award,    label:"Total Credits",value: `${prog.total_credits} Credits` },
          ].map((s) => (
      ...
      <section className="section" style={{ background:"var(--color-surface)" }}>
        <div className="container">
          <SectionHeader
            ...
            title="BHM Course Structure"
            subtitle={`4-year program · 8 Semesters · ${prog.total_credits} Total Credits · SCHOTEL Model`}
          />
          <SemesterTable semesters={BHM_SEMESTERS} accent={ACCENT} columns={2} />
        </div>
      </section>
